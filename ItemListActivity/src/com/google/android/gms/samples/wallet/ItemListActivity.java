...
public class ItemListActivity extends BikestoreFragmentActivity
    ...
    public static final String SCREEN_NAME = "Item List View";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTracker = ((BikestoreApplication) getApplication()).getTracker(BikestoreApplication.TrackerName.GLOBAL_TRACKER);

        HitBuilders.ScreenViewBuilder screenViewBuilder = new HitBuilders.ScreenViewBuilder();
        for (ItemInfo itemInfo: Constants.ITEMS_FOR_SALE){
            screenViewBuilder.addImpression(itemInfo.toProduct(), SCREEN_NAME);
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ProductAction productAction = new ProductAction(ProductAction.ACTION_DETAIL)
                .setProductActionList(SCREEN_NAME);

        HitBuilders.ScreenViewBuilder builder = new HitBuilders.ScreenViewBuilder()
                .addProduct(Constants.ITEMS_FOR_SALE[position].toProduct())
